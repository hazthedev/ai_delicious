...
export default function HeroMotion() {
  ...
  const whatsappHref = `https://wa.me/${site.whatsapp}?text=${encodeURIComponent("Hi! I'd like to enquire about Sunny Garden.")}`;
    ...
    <div className="max-w-5xl mx-auto px-5 text-center py-20">
      ...
      >
        ...
        >
          Chinese dumplings.
          <br />
          <span className="text-gold">Hidden in Setapak.</span>
        </motion.h1>
        ...
        >
          Since 2013, the quiet answer to a rare question — where to get authentic Chinese dumplings that are also halal. Three ways. Your choice.
        </motion.p>
